            ...
            <section className="py-12 bg-gray-50 border-y border-gray-100">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                        ...
                        <div>
                            <h3 className="text-xl font-black text-gray-900 mb-2 uppercase tracking-tight">Do I need a BER Certificate?</h3>
                        ...
                        <div className="md:ml-auto">
                            <Link to="/contact">
                                <button className="bg-white text-[#007F00] font-black px-8 py-3 rounded-xl border border-green-100 hover:bg-green-50 transition-all text-xs uppercase tracking-widest shadow-sm cursor-pointer">
                                    Book Now
                                </button>
                            </Link>
                        </div>
