...
export const generateCustomerConfirmationEmail = (record: any, businessName: string, tenant: string = 'ireland') => {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <div style="padding: 20px; border: 1px solid #ddd; border-top: none;">
        ...
        <p style="font-size: 16px;">${isSpanish ? 'Tu mensaje se ha enviado correctamente a' : 'Your message has been successfully sent to'} <strong>${businessName}</strong> ${isSpanish ? 'a través del Catálogo de Certificado Energético.' : 'via The Berman Catalogue.'}</p>
